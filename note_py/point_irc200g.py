...
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123044308_12CO_2-1_cross_OriKL_pointing/"#beam3
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123045413_12CO_2-1_cross_OriKL_pointing/"
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123054835_12CO_2-1_cross_OriKL_pointing/"
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123072522_12CO_2-1_cross_OriKL_pointing/"#beam4
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123074432_12CO_2-1_cross_IRC10216_pointing/"#beam3 
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123075532_12CO_2-1_cross_IRC10216_pointing/"#beam3 
#path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123080521_12CO_2-1_cross_IRC10216_pointing/"#beam3
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123081444_12CO_2-1_cross_IRC10216_pointing/"#beam3 
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123083525_12CO_2-1_cross_IRC10216_pointing/"#beam3
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123094859_12CO_2-1_cross_IRC10216_pointing/"#beam4
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191123095728_12CO_2-1_cross_IRC10216_pointing/"#beam4

path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191206081730_12CO_2-1_cross_IRC10216_pointing/"#beam1
#path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191206093630_12CO_2-1_cross_OriKL_pointing/"
#path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191207030315_12CO_2-1_cross_OriKL_pointing/"
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191208025938_12CO_2-1_cross_OriKL_pointing"
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191208033738_12CO_2-1_cross_OriKL_pointing"
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191208035155_12CO_2-1_cross_OriKL_pointing"
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191208040153_12CO_2-1_cross_OriKL_pointing"
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191208042241_12CO_2-1_cross_OriKL_pointing"
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191208043508_12CO_2-1_cross_OriKL_pointing"
...
path = "/home/amigos/nfs_hdd/data/radio_pointing_line_9/n20191218071928_12CO_2-1_cross_IRC10216_pointing/ "
...
for i in ["1.0", "2.0"]:
    mask1 = scannum == i
    mask = numpy.logical_and(mask1, offmask)
    offlist.append(numpy.mean(data[mask], axis=0))
...
xscan_Ta = []
for i in range(5):
    xscan_Ta.append(300*(onxlist[i] - offlist[0])/(hotlist[0] - offlist[0]))
    
yscan_Ta = []
for i in range(5):
    yscan_Ta.append(300*(onylist[i] - offlist[0])/(hotlist[0] - offlist[0]))
...
for i in range(5):
    xscan_Ta[i] = baseline_fitting(arr_x, xscan_Ta[i], 22000,22500, 23500, 24000)#12CO1-0(29,30,31,32)
    yscan_Ta[i] = baseline_fitting(arr_x, yscan_Ta[i],22000, 22500,23500, 24000)
    #xscan_Ta[i] = baseline_fitting(arr_x, xscan_Ta[i], 18800,19000, 20000, 20200)#12CO1-0(29,30,31,32)
    #xscan_Ta[i] = baseline_fitting(arr_x, xscan_Ta[i], 12400,12800, 13800, 14200)#12CO1-0(29,30,31,32)
    #yscan_Ta[i] = baseline_fitting(arr_x, yscan_Ta[i], 18800, 19000,20000, 20200)
    #yscan_Ta[i] = baseline_fitting(arr_x, yscan_Ta[i],12400, 12800, 13800, 14200)    
...
#try:    
    ...
    for i in [2,7,11,12,13,14,17,10,22]:
        axlist[i].set_ylim(-2, 12
                          )
        axlist[i].set_xlim(22000, 24000)
...
#hosei read
f_ = open('./hosei_230_20191212.txt', 'r')
